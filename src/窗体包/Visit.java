...
public class Visit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("欢迎使用消费者管理系统，请登录！");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String zh,mm;
        zh=jTextField1.getText().trim();
        mm=jTextField2.getText().trim();
        if(zh.equals("") || mm.equals("")){
           VisitErr1 Eone=new VisitErr1();
           Eone.setVisible(true);    
       }
       else{
             this.dispose();
             MainReal Mainone=new MainReal();
